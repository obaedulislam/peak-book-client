...
const Blog = () => {
    ...
    return (
        <div className='max-w-[1000px] mx-auto overflow-hidden lg:py-20 md:py-12 py-10  lg:px-0 md:px-4 px-3'>
            <div className='pb-10'>
                <h1 className='text-primary md:text-5xl sm:text-4xl text-2xl text-center font-specially font-bold  tracking-tight'>4 ReactJS Q & A</h1>
