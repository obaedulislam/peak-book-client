                    ...
                    <tbody>
                        {
                            users?.users?.map((user, i) => <tr>
                                ...
                                <td className="font-semibold text-sm text-center"><div className="">
                                    <Link className="text-center"><button className=" py-[2px] rounded-lg   px-2  bg-[#5C7CFA]   duration-300 hover:border-[#5C7CFA] hover:bg-accent text-white   text-xs font-semibold flex items-center uppercase"> Delete</button></Link>
                                </div></td>
