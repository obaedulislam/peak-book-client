...
const AdvertiseProduct = ({ product }) => {
    console.log(product);
    const { book_title, book_photo, published_date, resale_price, original_price, years_of_use, seller_name, verify_user, location, product_condition } = product;
        ...
        <div className='bg-gray-100   shadow-xl rounded-xl'>
            ...
            <div className='relative pb-5 pt-2 px-5 h-[320px]'>
                ...
                <div className="absolute w-full bottom-0 left-0 md:mt-5 mt-3">
                    <button
                        className="w-full  md:py-[12px] py-[5px] rounded-lg    bg-accent  duration-300 hover:border-[#5C7CFA] hover:bg-primary text-white   md:text-lg md:text-md text-sm font-semibold flex justify-center items-center uppercase"><BsCartPlusFill className='text-3xl mr-2'></BsCartPlusFill> Buy Now</button>
                </div>
            </div>
